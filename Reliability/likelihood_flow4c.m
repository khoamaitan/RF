function [ u, v,w ] = likelihood_flow4c( taux,meig,iD,u_pre,v_pre,ures,vres,lvl,warp,seq )
...
% Calculate weight of eigenc:
conv_eig = eval_eig(meig,5);


%taux =makemtrx_prop5(H,W,img2);
sum_taux=sum(taux,2);
...
%w=re_thresh(w,0,1);
if (lvl ==1) && (warp==1)    
    save(['C:\New\RF\analyze\' 'KLT_' seq '_uv_pre_lvl1warp1.mat'],'u','v','w')
end
if (lvl ==1) && (warp==10)    
    save(['C:\New\RF\analyze\KLT_' seq '_uv_pre_lvl1warp10.mat'],'u','v','w')
end
for i=1:max_iter
%    wold = w;
    %w=reshape(w,H,W);
...
if (lvl ==1) && (warp==1)    
    save(['C:\New\RF\analyze\KLT_' seq '_uv_post_lvl1warp1.mat'],'u','v','w')
end
if (lvl ==1) && (warp==10)    
    save(['C:\New\RF\analyze\KLT_' seq '_uv_post_lvl1warp10.mat'],'u','v','w')
end
